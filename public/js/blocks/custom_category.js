class CustomCategory extends Blockly.ToolboxCategory {
  ...
  createIconDom_() {
    ...
    if(window.localStorage) {
      ...
      if(lang === "hi") {
        this.name_ = this.name_.replace("Motion", "चाल");
        this.name_ = this.name_.replace("Tilling", "खेत जोतना");
        this.name_ = this.name_.replace("Harvest", "फ़सल कटाई");
        this.name_ = this.name_.replace("Control", "नियंत्रण");
      }
    }
